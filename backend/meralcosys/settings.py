"""
Django settings for meralcosys project.
...
CHATBOT_CONFIG_PATH = os.path.join(BASE_DIR, 'ml_models', 'knowledge_base.json')
...
SECRET_KEY = 'django-insecure-#k=y%g0a(u3bbx2o=ys6&wx#yvn*a+edopvs6opflj31hp)6d6'
...
WSGI_APPLICATION = 'meralcosys.wsgi.application'
...
AUTH_USER_MODEL = 'meralcoapp.User'
