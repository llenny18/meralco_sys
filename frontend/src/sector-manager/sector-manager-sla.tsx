// pages/sector-manager/sector-manager-sla.tsx
...
const COLUMNS = ['project', 'sla_rule', 'status', 'is_breached'];

function SectorManagerSla() {
  ...
  return (
    <>
      <Head><title>SLA Compliance - Sector Manager</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📈 SLA Compliance</Typography>
      ...
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="SLA Compliance Management" />
              <Divider />
              <CardContent>
...
SectorManagerSla.getLayout = (page) => <SidebarLayout userRole="sector-manager">{page}</SidebarLayout>;
export default SectorManagerSla;
