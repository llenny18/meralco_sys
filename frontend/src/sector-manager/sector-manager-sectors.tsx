// pages/sector-manager/sector-manager-sectors.tsx
...
const COLUMNS = ['sector_code', 'sector_name', 'sector_manager', 'location', 'is_active'];

function SectorManagerSectors() {
  ...
  return (
    <>
      <Head><title>Sector Overview - Sector Manager</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🗺️ Sector Overview</Typography>
            <Typography variant="subtitle2">Manage sector operations</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Sector Overview Management" />
              <Divider />
              <CardContent>
...
SectorManagerSectors.getLayout = (page) => <SidebarLayout userRole="sector-manager">{page}</SidebarLayout>;
export default SectorManagerSectors;
