// pages/sector-manager/sector-manager-penalties.tsx
...
const ENDPOINT = 'penalties';
const COLUMNS = ['project', 'vendor', 'penalty_amount', 'penalty_status'];

function SectorManagerPenalties() {
  ...
  return (
    <>
      <Head><title>Penalties Overview - Sector Manager</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚖️ Penalties Overview</Typography>
            <Typography variant="subtitle2">Monitor penalty records</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Penalties Overview Management" />
              <Divider />
              <CardContent>
...
SectorManagerPenalties.getLayout = (page) => <SidebarLayout userRole="sector-manager">{page}</SidebarLayout>;
export default SectorManagerPenalties;
