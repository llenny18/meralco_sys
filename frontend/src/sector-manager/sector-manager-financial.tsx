// pages/sector-manager/sector-manager-financial.tsx
...
const COLUMNS = ['invoice_number', 'vendor', 'invoice_amount', 'payment_status'];

function SectorManagerFinancial() {
  ...
  return (
    <>
      <Head><title>Financial Overview - Sector Manager</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💰 Financial Overview</Typography>
            <Typography variant="subtitle2">Financial performance metrics</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Financial Overview Management" />
              <Divider />
              <CardContent>
...
SectorManagerFinancial.getLayout = (page) => <SidebarLayout userRole="sector-manager">{page}</SidebarLayout>;
export default SectorManagerFinancial;
