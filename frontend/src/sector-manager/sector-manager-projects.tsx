// pages/sector-manager/sector-manager-projects.tsx
...
const COLUMNS = ['project_code', 'project_name', 'vendor', 'status', 'priority', 'contract_value', 'completion_date'];

function SectorManagerProjects() {
  ...
  return (
    <>
      <Head><title>Project Portfolio - Sector Manager</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📊 Project Portfolio</Typography>
            <Typography variant="subtitle2">Strategic project portfolio</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Project Portfolio Management" />
              <Divider />
              <CardContent>
...
SectorManagerProjects.getLayout = (page) => <SidebarLayout userRole="sector-manager">{page}</SidebarLayout>;
export default SectorManagerProjects;
