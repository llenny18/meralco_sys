// pages/sector-manager/sector-manager-vendor-performance.tsx
...
const COLUMNS = ['vendor', 'evaluation_date', 'overall_rating', 'compliance_score'];

function SectorManagerVendorPerformance() {
  ...
  return (
    <>
      <Head><title>Vendor Performance - Sector Manager</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⭐ Vendor Performance</Typography>
            <Typography variant="subtitle2">Executive vendor overview</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
SectorManagerVendorPerformance.getLayout = (page) => <SidebarLayout userRole="sector-manager">{page}</SidebarLayout>;
export default SectorManagerVendorPerformance;
