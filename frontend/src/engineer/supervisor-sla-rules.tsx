// pages/supervisor/supervisor-sla-rules.tsx
...
function SupervisorSlaRules() {
  ...
  return (
    <>
      <Head><title>SLA Rules - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚖️ SLA Rules</Typography>
            <Typography variant="subtitle2">Manage SLA rules</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="SLA Rules Management" />
              <Divider />
              <CardContent>
...
SupervisorSlaRules.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorSlaRules;
