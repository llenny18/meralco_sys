// pages/supervisor/supervisor-vendor-disputes.tsx
...
const ENDPOINT = 'vendor-disputes';
const COLUMNS = ['vendor', 'project', 'dispute_subject', 'dispute_status', 'submitted_date', 'assigned_to', 'resolution_date'];

function SupervisorVendorDisputes() {
  ...
  return (
    <>
      <Head><title>Vendor Disputes - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚔️ Vendor Disputes</Typography>
            <Typography variant="subtitle2">Handle vendor disputes</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Vendor Disputes Management" />
              <Divider />
              <CardContent>
...
SupervisorVendorDisputes.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorVendorDisputes;
