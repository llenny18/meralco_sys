// pages/supervisor/supervisor-documents.tsx
...
const ENDPOINT = 'project-documents';
const COLUMNS = ['project', 'doc_type', 'document_name', 'uploaded_by', 'upload_date', 'approval_status', 'approved_by'];

function SupervisorDocuments() {
  ...
  return (
    <>
      <Head><title>Project Documents - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📄 Project Documents</Typography>
            <Typography variant="subtitle2">Manage all documents</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Project Documents Management" />
              <Divider />
              <CardContent>
...
SupervisorDocuments.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
