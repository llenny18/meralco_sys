// pages/supervisor/supervisor-vendors.tsx
...
const COLUMNS = ['vendor_code', 'vendor_name', 'company_name', 'email', 'phone_number', 'compliance_score', 'is_active', 'is_blacklisted'];

function SupervisorVendors() {
  ...
  return (
    <>
      <Head><title>Vendors - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🏢 Vendors</Typography>
            <Typography variant="subtitle2">Manage vendor information</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Vendors Management" />
              <Divider />
              <CardContent>
...
SupervisorVendors.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
