// pages/supervisor/supervisor-vendor-feedback.tsx
...
const ENDPOINT = 'vendor-feedback';
const COLUMNS = ['vendor', 'feedback_type', 'feedback_subject', 'rating', 'status', 'reviewed_by'];

function SupervisorVendorFeedback() {
  ...
  return (
    <>
      <Head><title>Vendor Feedback - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💬 Vendor Feedback</Typography>
            <Typography variant="subtitle2">Review vendor feedback</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Vendor Feedback Management" />
              <Divider />
              <CardContent>
...
SupervisorVendorFeedback.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorVendorFeedback;
