// pages/supervisor/supervisor-qi-inspections.tsx
...
const COLUMNS = ['project', 'inspection_type', 'assigned_qi', 'scheduled_date', 'inspection_date', 'inspection_result', 'is_completed'];

function SupervisorQiInspections() {
  ...
  return (
    <>
      <Head><title>QI Inspections - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔍 QI Inspections</Typography>
            <Typography variant="subtitle2">Oversee quality inspections</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
SupervisorQiInspections.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorQiInspections;
