// pages/supervisor/supervisor-notifications.tsx
...
const COLUMNS = ['recipient_user', 'notification_type', 'subject', 'status', 'sent_at', 'delivered_at', 'read_at'];
...
function SupervisorNotifications() {
  ...
  return (
    <>
      <Head><title>Notifications - WO Supervisor</title></Head>
      <PageTitleWrapper>
...
SupervisorNotifications.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
