// pages/supervisor/supervisor-penalties.tsx
...
const COLUMNS = ['project', 'vendor', 'penalty_rule', 'violation_date', 'delay_days', 'penalty_amount', 'penalty_status', 'issue_date'];

function SupervisorPenalties() {
  ...
  return (
    <>
      <Head><title>Penalties - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💰 Penalties</Typography>
            <Typography variant="subtitle2">Manage penalties</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Penalties Management" />
              <Divider />
              <CardContent>
...
SupervisorPenalties.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
