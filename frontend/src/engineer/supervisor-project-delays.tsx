// pages/supervisor/supervisor-project-delays.tsx
...
const COLUMNS = ['project', 'factor', 'delay_days', 'delay_start_date', 'delay_end_date', 'responsible_party'];

function SupervisorProjectDelays() {
  ...
  return (
    <>
      <Head><title>Project Delays - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⏱️ Project Delays</Typography>
            <Typography variant="subtitle2">Track project delays</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
SupervisorProjectDelays.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorProjectDelays;
