// pages/supervisor/supervisor-change-logs.tsx
...
function SupervisorChangeLogs() {
  ...
  return (
    <>
      <Head><title>Change Logs - WO Supervisor</title></Head>
      <PageTitleWrapper>
...
SupervisorChangeLogs.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorChangeLogs;
