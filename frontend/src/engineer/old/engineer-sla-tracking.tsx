// pages/engineer/engineer-sla-tracking.tsx
...
function EngineerSlaTracking() {
  ...
  return (
    <>
      <Head><title>SLA Tracking - Engineer Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⏱️ SLA Tracking</Typography>
...
EngineerSlaTracking.getLayout = (page) => <SidebarLayout userRole="engineer">{page}</SidebarLayout>;
export default EngineerSlaTracking;
