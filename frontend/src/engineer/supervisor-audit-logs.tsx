// pages/supervisor/supervisor-audit-logs.tsx
...
const COLUMNS = ['user', 'action_type', 'action_description', 'entity_type', 'status', 'created_at'];

function SupervisorAuditLogs() {
  ...
  return (
    <>
      <Head><title>Audit Logs - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔒 Audit Logs</Typography>
            <Typography variant="subtitle2">View audit logs</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Audit Logs Management" />
              <Divider />
              <CardContent>
...
SupervisorAuditLogs.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorAuditLogs;
