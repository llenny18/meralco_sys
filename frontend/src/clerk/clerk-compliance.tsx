// pages/clerk/clerk-compliance.tsx
...
const ENDPOINT = 'document-compliance';
const COLUMNS = ['project', 'doc_type', 'is_submitted', 'submission_date', 'is_approved', 'is_overdue', 'overdue_days'];

function ClerkCompliance() {
  ...
  return (
    <>
      <Head><title>Document Compliance - Clerk Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>✅ Document Compliance</Typography>
            <Typography variant="subtitle2">Track document compliance status</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Document Compliance Management" />
              <Divider />
              <CardContent>
...
ClerkCompliance.getLayout = (page) => <SidebarLayout userRole="clerk">{page}</SidebarLayout>;
export default ClerkCompliance;
