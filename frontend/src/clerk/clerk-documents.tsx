// pages/clerk/clerk-documents.tsx
...
const COLUMNS = ['project', 'doc_type', 'document_name', 'uploaded_by', 'upload_date', 'approval_status', 'is_current_version'];
...
function ClerkDocuments() {
  ...
  return (
    <>
      <Head><title>Documents - Clerk Portal</title></Head>
      <PageTitleWrapper>
...
ClerkDocuments.getLayout = (page) => <SidebarLayout userRole="clerk">{page}</SidebarLayout>;
