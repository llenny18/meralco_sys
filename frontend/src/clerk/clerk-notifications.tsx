// pages/clerk/clerk-notifications.tsx
...
const COLUMNS = ['recipient_user', 'notification_type', 'subject', 'status', 'sent_at', 'delivered_at'];

function ClerkNotifications() {
  ...
  return (
    <>
      <Head><title>Notifications - Clerk Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔔 Notifications</Typography>
            <Typography variant="subtitle2">Manage notifications</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
ClerkNotifications.getLayout = (page) => <SidebarLayout userRole="clerk">{page}</SidebarLayout>;
export default ClerkNotifications;
