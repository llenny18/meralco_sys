// pages/clerk/clerk-document-types.tsx
...
const COLUMNS = ['doc_type_name', 'doc_type_description', 'is_required', 'created_at'];

function ClerkDocumentTypes() {
  ...
  return (
    <>
      <Head><title>Document Types - Clerk Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📋 Document Types</Typography>
            <Typography variant="subtitle2">Manage document type definitions</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
ClerkDocumentTypes.getLayout = (page) => <SidebarLayout userRole="clerk">{page}</SidebarLayout>;
export default ClerkDocumentTypes;
