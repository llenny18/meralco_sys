// pages/clerk/clerk-change-logs.tsx
...
function ClerkChangeLogs() {
  ...
  return (
    <>
      <Head><title>Change Logs - Clerk Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📋 Change Logs</Typography>
            <Typography variant="subtitle2">View system change history</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
ClerkChangeLogs.getLayout = (page) => <SidebarLayout userRole="clerk">{page}</SidebarLayout>;
export default ClerkChangeLogs;
