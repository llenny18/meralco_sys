// pages/clerk/clerk-projects.tsx
...
const COLUMNS = ['project_code', 'project_name', 'vendor', 'status', 'assigned_engineer', 'start_date', 'completion_date'];

function ClerkProjects() {
  ...
  return (
    <>
      <Head><title>Projects - Clerk Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📁 Projects</Typography>
            <Typography variant="subtitle2">Manage project records</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
ClerkProjects.getLayout = (page) => <SidebarLayout userRole="clerk">{page}</SidebarLayout>;
export default ClerkProjects;
