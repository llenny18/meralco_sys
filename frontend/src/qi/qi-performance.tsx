...
const COLUMNS = ['evaluation_period_start', 'evaluation_period_end', 'total_inspections', 'on_time_percentage', 'targets_met', 'targets_missed', 'quality_rating'];

function QiPerformance() {
  ...
  return (
    <>
      <Head><title>Performance - Quality Inspector</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📊 Performance</Typography>
            <Typography variant="subtitle2">View performance metrics</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Performance Management" />
              <Divider />
              <CardContent>
...
QiPerformance.getLayout = (page) => <SidebarLayout userRole="qi">{page}</SidebarLayout>;
export default QiPerformance;
