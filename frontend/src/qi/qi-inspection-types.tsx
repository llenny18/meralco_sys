// pages/qi/qi-inspection-types.tsx
...
const ENDPOINT = 'inspection-types';
const COLUMNS = ['inspection_name', 'inspection_description', 'estimated_duration_hours', 'created_at'];

function QiInspectionTypes() {
  ...
  return (
    <>
      <Head><title>Inspection Types - Quality Inspector</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📋 Inspection Types</Typography>
            <Typography variant="subtitle2">View inspection type definitions</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Inspection Types Management" />
              <Divider />
              <CardContent>
...
QiInspectionTypes.getLayout = (page) => <SidebarLayout userRole="qi">{page}</SidebarLayout>;
export default QiInspectionTypes;
