...
const COLUMNS = ['project_code', 'project_name', 'vendor', 'sector', 'status', 'assigned_qi'];
...
function QiProjects() {
  ...
  return (
    <>
      <Head><title>Projects - Quality Inspector</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📁 Projects</Typography>
            <Typography variant="subtitle2">View assigned projects</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
QiProjects.getLayout = (page) => <SidebarLayout userRole="qi">{page}</SidebarLayout>;
