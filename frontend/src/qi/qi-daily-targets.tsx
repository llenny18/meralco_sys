...
const COLUMNS = ['target_date', 'target_audits', 'actual_audits', 'target_met', 'reason_not_met', 'reason_category'];
...
function QiDailyTargets() {
  ...
  return (
    <>
      <Head><title>Daily Targets - Quality Inspector</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🎯 Daily Targets</Typography>
            <Typography variant="subtitle2">Track daily inspection targets</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Daily Targets Management" />
              <Divider />
              <CardContent>
...
QiDailyTargets.getLayout = (page) => <SidebarLayout userRole="qi">{page}</SidebarLayout>;
