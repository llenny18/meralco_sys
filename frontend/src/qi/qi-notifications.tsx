...
const COLUMNS = ['notification_type', 'subject', 'message', 'status', 'sent_at'];

function QiNotifications() {
  ...
  return (
    <>
      <Head><title>Notifications - Quality Inspector</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔔 Notifications</Typography>
            <Typography variant="subtitle2">View your notifications</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
QiNotifications.getLayout = (page) => <SidebarLayout userRole="qi">{page}</SidebarLayout>;
export default QiNotifications;
