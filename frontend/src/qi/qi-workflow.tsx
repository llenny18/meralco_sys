...
const COLUMNS = ['project', 'stage', 'assigned_user', 'due_date', 'status', 'is_current_stage'];
...
function QiWorkflow() {
  ...
  return (
    <>
      <Head><title>Workflow - Quality Inspector</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔄 Workflow</Typography>
            <Typography variant="subtitle2">Track project workflow</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
QiWorkflow.getLayout = (page) => <SidebarLayout userRole="qi">{page}</SidebarLayout>;
export default QiWorkflow;
