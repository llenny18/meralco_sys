// pages/aide/aide-workflow-stages.tsx
...
const COLUMNS = ['stage_name', 'stage_description', 'stage_order', 'default_duration_days', 'is_active'];

function AideWorkflowStages() {
  ...
  return (
    <>
      <Head><title>Workflow Stages - Engineering Aide</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📝 Workflow Stages</Typography>
            <Typography variant="subtitle2">Manage workflow stage definitions</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
AideWorkflowStages.getLayout = (page) => <SidebarLayout userRole="aide">{page}</SidebarLayout>;
export default AideWorkflowStages;
