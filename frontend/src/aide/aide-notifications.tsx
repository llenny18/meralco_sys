// pages/aide/aide-notifications.tsx
...
const COLUMNS = ['recipient_user', 'notification_type', 'subject', 'status', 'sent_at', 'read_at'];

function AideNotifications() {
  ...
  return (
    <>
      <Head><title>Notifications - Engineering Aide</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔔 Notifications</Typography>
            <Typography variant="subtitle2">View notifications</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
AideNotifications.getLayout = (page) => <SidebarLayout userRole="aide">{page}</SidebarLayout>;
export default AideNotifications;
