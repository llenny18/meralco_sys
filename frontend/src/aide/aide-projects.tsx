...
const COLUMNS = ['project_code', 'project_name', 'vendor', 'sector', 'status', 'priority', 'start_date', 'completion_date', 'is_delayed'];

function AideProjects() {
  ...
  return (
    <>
      <Head><title>Projects - Engineering Aide</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📊 Projects</Typography>
            <Typography variant="subtitle2">Coordinate project activities</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
AideProjects.getLayout = (page) => <SidebarLayout userRole="aide">{page}</SidebarLayout>;
export default AideProjects;
