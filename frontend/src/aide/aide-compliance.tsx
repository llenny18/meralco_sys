// pages/aide/aide-compliance.tsx
...
const COLUMNS = ['project', 'doc_type', 'is_submitted', 'submission_date', 'is_approved', 'due_date', 'is_overdue'];

function AideCompliance() {
  ...
  return (
    <>
      <Head><title>Document Compliance - Engineering Aide</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>✅ Document Compliance</Typography>
            <Typography variant="subtitle2">Monitor document compliance</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
AideCompliance.getLayout = (page) => <SidebarLayout userRole="aide">{page}</SidebarLayout>;
export default AideCompliance;
