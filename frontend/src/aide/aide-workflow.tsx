...
function AideWorkflow() {
  ...
  return (
    <>
      <Head><title>Workflow - Engineering Aide</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔄 Workflow</Typography>
            <Typography variant="subtitle2">Track project workflow stages</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
AideWorkflow.getLayout = (page) => <SidebarLayout userRole="aide">{page}</SidebarLayout>;
export default AideWorkflow;
