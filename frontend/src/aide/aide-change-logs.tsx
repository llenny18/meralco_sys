// pages/aide/aide-change-logs.tsx
...
const COLUMNS = ['table_name', 'record_id', 'change_type', 'field_name', 'changed_by', 'created_at'];

function AideChangeLogs() {
  ...
  return (
    <>
      <Head><title>Change History - Engineering Aide</title></Head>
      <PageTitleWrapper>
...
AideChangeLogs.getLayout = (page) => <SidebarLayout userRole="aide">{page}</SidebarLayout>;
export default AideChangeLogs;
