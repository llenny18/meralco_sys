...
const COLUMNS = ['project', 'doc_type', 'document_name', 'uploaded_by', 'upload_date', 'approval_status'];

function AideDocuments() {
  ...
  return (
    <>
      <Head><title>Documents - Engineering Aide</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📄 Documents</Typography>
            <Typography variant="subtitle2">Manage project documents</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
AideDocuments.getLayout = (page) => <SidebarLayout userRole="aide">{page}</SidebarLayout>;
export default AideDocuments;
