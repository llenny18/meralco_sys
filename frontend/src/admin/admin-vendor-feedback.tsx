// pages/admin/admin-vendor-feedback.tsx
...
const COLUMNS = ['vendor', 'feedback_type', 'feedback_subject', 'rating', 'status', 'reviewed_by', 'review_date', 'response'];
...
function VendorFeedback() {
  ...
  return (
    <>
      <Head><title>Vendor Feedback - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💬 Vendor Feedback</Typography>
            <Typography variant="subtitle2">Review and respond to vendor feedback</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
VendorFeedback.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
