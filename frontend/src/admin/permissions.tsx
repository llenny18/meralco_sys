...
const COLUMNS =  ['permission_name', 'permission_description', 'module_name','created_at'];
...
function UsersTable() {
  ...
  return (
    <>
      <Head><title>Permissions - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>Permissions</Typography>
            <Typography variant="subtitle2">Manage system user permissions and their information</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
UsersTable.getLayout = (page) => <SidebarLayout  userRole="admin">{page}</SidebarLayout>;
