// pages/admin/admin-delay-factors.tsx
...
function DelayFactors() {
  ...
  return (
    <>
      <Head><title>Delay Factors - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⏱️ Delay Factors</Typography>
            <Typography variant="subtitle2">Define and categorize project delay factors</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
DelayFactors.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
export default DelayFactors;
