// pages/admin/admin-vendor-disputes.tsx
...
const COLUMNS = ['vendor', 'project', 'dispute_type', 'dispute_subject', 'dispute_status', 'submitted_date', 'assigned_to', 'resolution', 'resolved_by', 'resolution_date'];

function VendorDisputes() {
  ...
  return (
    <>
      <Head><title>Vendor Disputes - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚔️ Vendor Disputes</Typography>
            <Typography variant="subtitle2">Handle vendor disputes and resolutions</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
VendorDisputes.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
