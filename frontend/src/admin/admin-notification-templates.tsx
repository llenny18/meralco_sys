// pages/admin/admin-notification-templates.tsx
...
const COLUMNS = ['template_name', 'template_subject', 'notification_type', 'is_active', 'created_at', 'updated_at'];
...
function NotificationTemplates() {
  ...
  return (
    <>
      <Head><title>Notification Templates - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📝 Notification Templates</Typography>
            <Typography variant="subtitle2">Manage notification email and message templates</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
NotificationTemplates.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
