// pages/admin/admin-penalties.tsx
...
const COLUMNS = ['project', 'vendor', 'penalty_rule', 'violation_date', 'delay_days', 'penalty_amount', 'penalty_status', 'issue_date', 'payment_date', 'waived_by'];
...
function Penalties() {
  ...
  return (
    <>
      <Head><title>Penalties - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💰 Penalties</Typography>
            <Typography variant="subtitle2">Manage penalty records and payments</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
Penalties.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
