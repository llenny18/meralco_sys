// pages/admin/admin-qi-inspections.tsx
...
function QiInspections() {
  ...
  return (
    <>
      <Head><title>QI Inspections - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔍 QI Inspections</Typography>
            <Typography variant="subtitle2">Manage quality inspections and their results</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
QiInspections.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
