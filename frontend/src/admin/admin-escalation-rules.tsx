// pages/admin/admin-escalation-rules.tsx
...
const COLUMNS = ['rule_name', 'rule_description', 'trigger_condition', 'delay_threshold_days', 'escalate_to_role', 'notification_template', 'is_active'];
...
function EscalationRules() {
  ...
  return (
    <>
      <Head><title>Escalation Rules - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚠️ Escalation Rules</Typography>
            <Typography variant="subtitle2">Configure automatic escalation rules and triggers</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
EscalationRules.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
