// pages/admin/admin-penalty-rules.tsx
...
const COLUMNS = ['rule_name', 'rule_description', 'violation_type', 'penalty_formula', 'minimum_penalty', 'maximum_penalty', 'grace_period_days', 'is_active'];
...
function PenaltyRules() {
  ...
  return (
    <>
      <Head><title>Penalty Rules - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚖️ Penalty Rules</Typography>
            <Typography variant="subtitle2">Configure penalty rules and violation types</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
PenaltyRules.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
