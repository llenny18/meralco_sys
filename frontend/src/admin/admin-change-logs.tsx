// pages/admin/admin-change-logs.tsx
...
const COLUMNS = ['table_name', 'record_id', 'change_type', 'field_name', 'old_value', 'new_value', 'changed_by', 'change_reason', 'ip_address', 'created_at'];
...
function ChangeLogs() {
  ...
  return (
    <>
      <Head><title>Change Logs - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📋 Change Logs</Typography>
            <Typography variant="subtitle2">Track all database changes and modifications</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Change Logs Management" />
              <Divider />
              <CardContent>
...
ChangeLogs.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
