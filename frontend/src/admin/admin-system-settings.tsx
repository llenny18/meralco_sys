// pages/admin/admin-system-settings.tsx
...
function SystemSettings() {
  ...
  return (
    <>
      <Head><title>System Settings - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚙️ System Settings</Typography>
            <Typography variant="subtitle2">Configure system-wide settings and parameters</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="System Settings Management" />
              <Divider />
              <CardContent>
...
SystemSettings.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
