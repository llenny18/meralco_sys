// pages/admin/admin-qi-performance.tsx
...
const COLUMNS = ['qi_user', 'evaluation_period_start', 'evaluation_period_end', 'total_inspections', 'on_time_percentage', 'targets_met', 'targets_missed', 'quality_rating'];
...
function QiPerformance() {
  ...
  return (
    <>
      <Head><title>QI Performance - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📊 QI Performance</Typography>
            <Typography variant="subtitle2">Monitor QI team performance metrics</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader  title="QI Performance Management" />
              <Divider />
              <CardContent>
...
QiPerformance.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
