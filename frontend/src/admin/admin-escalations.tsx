// pages/admin/admin-escalations.tsx
...
function Escalations() {
  ...
  return (
    <>
      <Head><title>Escalations - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🚨 Escalations</Typography>
            <Typography variant="subtitle2">Track and manage escalated issues</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
Escalations.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
