// pages/admin/admin-audit-logs.tsx
...
const COLUMNS = ['user', 'action_type', 'action_description', 'entity_type', 'entity_id', 'ip_address', 'user_agent', 'status', 'error_message', 'created_at'];
...
function AuditLogs() {
  ...
  return (
    <>
      <Head><title>System Audit Logs - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔒 System Audit Logs</Typography>
            <Typography variant="subtitle2">Monitor system access and security events</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="System Audit Logs Management" />
              <Divider />
              <CardContent>
...
AuditLogs.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
