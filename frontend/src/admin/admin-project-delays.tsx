// pages/admin/admin-project-delays.tsx
...
const COLUMNS = ['project', 'factor', 'delay_days', 'delay_start_date', 'delay_end_date', 'responsible_party', 'notes', 'reported_by'];
...
function ProjectDelays() {
  ...
  return (
    <>
      <Head><title>Project Delays - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📅 Project Delays</Typography>
            <Typography variant="subtitle2">Monitor and analyze project delays</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
ProjectDelays.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
