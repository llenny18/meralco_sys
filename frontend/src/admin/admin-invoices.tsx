// pages/admin/admin-invoices.tsx
...
const COLUMNS = ['invoice_number', 'project', 'vendor', 'invoice_date', 'due_date', 'invoice_amount', 'penalty_amount', 'net_amount', 'payment_status', 'payment_date'];
...
function Invoices() {
  ...
  return (
    <>
      <Head><title>Invoices - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🧾 Invoices</Typography>
            <Typography variant="subtitle2">Manage invoices and billing information</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader  title="Invoices Management" />
              <Divider />
              <CardContent>
...
Invoices.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
