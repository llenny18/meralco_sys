// pages/admin/admin-notifications.tsx
...
const COLUMNS = ['recipient_user', 'recipient_email', 'notification_type', 'subject', 'status', 'sent_at', 'delivered_at', 'read_at', 'error_message'];
...
function Notifications() {
  ...
  return (
    <>
      <Head><title>Notifications - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔔 Notifications</Typography>
            <Typography variant="subtitle2">View notification delivery status and history</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Notifications Management" />
              <Divider />
              <CardContent>
...
Notifications.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
