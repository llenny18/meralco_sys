// pages/admin/admin-payments.tsx
...
const COLUMNS = ['invoice', 'payment_amount', 'payment_date', 'payment_method', 'payment_reference', 'processed_by', 'created_at'];
...
function Payments() {
  ...
  return (
    <>
      <Head><title>Payments - System Administration</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💳 Payments</Typography>
            <Typography variant="subtitle2">Track payment transactions and processing</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Payments Management" />
              <Divider />
              <CardContent>
...
Payments.getLayout = (page) => <SidebarLayout userRole="admin">{page}</SidebarLayout>;
