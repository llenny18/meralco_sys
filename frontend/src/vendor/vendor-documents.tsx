// pages/vendor/vendor-documents.tsx
...
const COLUMNS = ['project', 'doc_type', 'document_name', 'upload_date', 'approval_status', 'version_number'];
...
function VendorDocuments() {
  ...
  return (
    <>
      <Head><title>Document Upload - Vendor Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📄 Document Upload</Typography>
            <Typography variant="subtitle2">Upload and manage project documents</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Document Upload Management" />
              <Divider />
              <CardContent>
...
VendorDocuments.getLayout = (page) => <SidebarLayout userRole="vendor">{page}</SidebarLayout>;
