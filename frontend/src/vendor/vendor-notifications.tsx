// pages/vendor/vendor-notifications.tsx
...
const COLUMNS = ['notification_type', 'subject', 'message', 'status', 'sent_at', 'read_at'];
...
function VendorNotifications() {
  ...
  return (
    <>
      <Head><title>Notifications - Vendor Portal</title></Head>
      <PageTitleWrapper>
...
VendorNotifications.getLayout = (page) => <SidebarLayout userRole="vendor">{page}</SidebarLayout>;
