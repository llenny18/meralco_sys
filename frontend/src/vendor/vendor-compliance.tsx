// pages/vendor/vendor-compliance.tsx
...
function VendorCompliance() {
  ...
  return (
    <>
      <Head><title>Document Compliance - Vendor Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>✅ Document Compliance</Typography>
            <Typography variant="subtitle2">Track document submission compliance</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
VendorCompliance.getLayout = (page) => <SidebarLayout userRole="vendor">{page}</SidebarLayout>;
