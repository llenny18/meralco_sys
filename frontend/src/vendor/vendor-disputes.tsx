// pages/vendor/vendor-disputes.tsx
...
const COLUMNS = ['dispute_subject', 'dispute_type', 'dispute_status', 'submitted_date', 'resolution_date'];
...
function VendorDisputes() {
  ...
  return (
    <>
      <Head><title>Disputes - Vendor Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚔️ Disputes</Typography>
            <Typography variant="subtitle2">Submit and track disputes</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Disputes Management" />
              <Divider />
              <CardContent>
...
VendorDisputes.getLayout = (page) => <SidebarLayout userRole="vendor">{page}</SidebarLayout>;
