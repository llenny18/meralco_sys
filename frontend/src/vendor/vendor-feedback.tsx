// pages/vendor/vendor-feedback.tsx
...
const COLUMNS = ['feedback_type', 'feedback_subject', 'rating', 'status', 'created_at'];
...
function VendorFeedback() {
  ...
  return (
    <>
      <Head><title>Feedback - Vendor Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💬 Feedback</Typography>
            <Typography variant="subtitle2">Provide feedback and suggestions</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Feedback Management" />
              <Divider />
              <CardContent>
...
VendorFeedback.getLayout = (page) => <SidebarLayout userRole="vendor">{page}</SidebarLayout>;
