// pages/vendor/vendor-payments.tsx
...
const COLUMNS = ['invoice', 'payment_amount', 'payment_date', 'payment_method', 'payment_reference'];
...
function VendorPayments() {
  ...
  return (
    <>
      <Head><title>Payments - Vendor Portal</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💳 Payments</Typography>
            <Typography variant="subtitle2">Track payment history</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
VendorPayments.getLayout = (page) => <SidebarLayout userRole="vendor">{page}</SidebarLayout>;
