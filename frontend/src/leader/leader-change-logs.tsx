// pages/leader/leader-change-logs.tsx
...
const COLUMNS = ['table_name', 'record_id', 'change_type', 'changed_by', 'created_at'];

function LeaderChangeLogs() {
  ...
  return (
    <>
      <Head><title>Change Logs - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📋 Change Logs</Typography>
            <Typography variant="subtitle2">View system changes</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
LeaderChangeLogs.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderChangeLogs;
