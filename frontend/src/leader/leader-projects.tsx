// pages/leader/leader-projects.tsx
...
const COLUMNS = ['project_code', 'project_name', 'vendor', 'sector', 'status', 'assigned_engineer', 'assigned_qi', 'wo_supervisor', 'priority', 'risk_score'];

function LeaderProjects() {
  ...
  return (
    <>
      <Head><title>All Projects - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🏗️ All Projects</Typography>
            <Typography variant="subtitle2">Strategic project oversight</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
LeaderProjects.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
