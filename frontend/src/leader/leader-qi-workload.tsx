// pages/leader/leader-qi-workload.tsx
...
function LeaderQiWorkload() {
  ...
  return (
    <>
      <Head><title>QI Workload Analysis - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📋 QI Workload Analysis</Typography>
            <Typography variant="subtitle2">Analyze QI workload</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="QI Workload Analysis Management" />
              <Divider />
              <CardContent>
...
LeaderQiWorkload.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderQiWorkload;
