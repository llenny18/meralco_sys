// pages/leader/leader-sectors.tsx
...
function LeaderSectors() {
  ...
  return (
    <>
      <Head><title>Sectors - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🗺️ Sectors</Typography>
            <Typography variant="subtitle2">Manage organizational sectors</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Sectors Management" />
              <Divider />
              <CardContent>
...
LeaderSectors.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderSectors;
