// pages/leader/leader-project-status.tsx
...
const ENDPOINT = 'project-statuses';
const COLUMNS = ['status_name', 'status_description', 'status_order', 'status_color', 'is_active'];

function LeaderProjectStatus() {
  ...
  return (
    <>
      <Head><title>Project Status - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🚦 Project Status</Typography>
            <Typography variant="subtitle2">Configure project statuses</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Project Status Management" />
              <Divider />
              <CardContent>
...
LeaderProjectStatus.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderProjectStatus;
