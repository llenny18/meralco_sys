// pages/leader/leader-billing.tsx
...
const COLUMNS = ['invoice_number', 'project', 'vendor', 'invoice_date', 'invoice_amount', 'payment_status'];

function LeaderBilling() {
  ...
  return (
    <>
      <Head><title>Billing Overview - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🧾 Billing Overview</Typography>
            <Typography variant="subtitle2">Monitor billing activities</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Billing Overview Management" />
              <Divider />
              <CardContent>
...
LeaderBilling.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderBilling;
