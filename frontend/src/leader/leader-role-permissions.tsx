// pages/leader/leader-role-permissions.tsx
...
const COLUMNS = ['role', 'permission', 'created_at'];

function LeaderRolePermissions() {
  ...
  return (
    <>
      <Head><title>Role Permissions - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔑 Role Permissions</Typography>
            <Typography variant="subtitle2">Assign permissions to roles</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Role Permissions Management" />
              <Divider />
              <CardContent>
...
LeaderRolePermissions.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderRolePermissions;
