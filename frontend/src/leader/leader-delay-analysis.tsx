// pages/leader/leader-delay-analysis.tsx
...
const ENDPOINT = 'project-delays';
const COLUMNS = ['project', 'factor', 'delay_days', 'responsible_party', 'delay_start_date'];

function LeaderDelayAnalysis() {
  ...
  return (
    <>
      <Head><title>Delay Analysis - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⏱️ Delay Analysis</Typography>
            <Typography variant="subtitle2">Analyze project delays</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Delay Analysis Management" />
              <Divider />
              <CardContent>
...
LeaderDelayAnalysis.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderDelayAnalysis;
