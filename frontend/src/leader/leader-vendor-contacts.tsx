// pages/leader/leader-vendor-contacts.tsx
...
const ENDPOINT = 'vendor-contacts';
const COLUMNS = ['vendor', 'contact_name', 'contact_position', 'contact_email', 'is_primary'];

function LeaderVendorContacts() {
  ...
  return (
    <>
      <Head><title>Vendor Contacts - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📞 Vendor Contacts</Typography>
            <Typography variant="subtitle2">Manage vendor contacts</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Vendor Contacts Management" />
              <Divider />
              <CardContent>
...
LeaderVendorContacts.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderVendorContacts;
