// pages/leader/leader-escalations.tsx
...
const COLUMNS = ['project', 'escalation_rule', 'escalated_to_user', 'escalation_date', 'status', 'resolution_date'];

function LeaderEscalations() {
  ...
  return (
    <>
      <Head><title>Escalation Management - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🚨 Escalation Management</Typography>
            <Typography variant="subtitle2">Handle escalated issues</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Escalation Management Management" />
              <Divider />
              <CardContent>
...
LeaderEscalations.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderEscalations;
