// pages/leader/leader-vendor-analytics.tsx
...
const COLUMNS = ['vendor', 'evaluation_date', 'on_time_rate', 'document_submission_rate', 'quality_score', 'compliance_score', 'overall_rating'];

function LeaderVendorAnalytics() {
  ...
  return (
    <>
      <Head><title>Vendor Analytics - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📊 Vendor Analytics</Typography>
            <Typography variant="subtitle2">Analyze vendor performance</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Vendor Analytics Management" />
              <Divider />
              <CardContent>
...
LeaderVendorAnalytics.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderVendorAnalytics;
