// pages/leader/leader-penalty-rules.tsx
...
const COLUMNS = ['rule_name', 'violation_type', 'penalty_formula', 'minimum_penalty', 'maximum_penalty'];

function LeaderPenaltyRules() {
  ...
  return (
    <>
      <Head><title>Penalty Rules - Team Leader</title></Head>
      <PageTitleWrapper>
...
LeaderPenaltyRules.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderPenaltyRules;
