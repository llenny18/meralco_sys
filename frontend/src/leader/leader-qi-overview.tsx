// pages/leader/leader-qi-overview.tsx
...
const COLUMNS = ['qi_user', 'evaluation_period_start', 'evaluation_period_end', 'total_inspections', 'on_time_percentage', 'targets_met', 'targets_missed'];

function LeaderQiOverview() {
  ...
  return (
    <>
      <Head><title>QI Performance Overview - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📊 QI Performance Overview</Typography>
            <Typography variant="subtitle2">Monitor QI team performance</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="QI Performance Overview Management" />
              <Divider />
              <CardContent>
...
LeaderQiOverview.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderQiOverview;
