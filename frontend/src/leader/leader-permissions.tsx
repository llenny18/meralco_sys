// pages/leader/leader-permissions.tsx
...
const COLUMNS = ['permission_name', 'permission_description', 'module_name'];
...
function LeaderPermissions() {
  ...
  return (
    <>
      <Head><title>Permissions - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔐 Permissions</Typography>
            <Typography variant="subtitle2">Manage system permissions</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Permissions Management" />
              <Divider />
              <CardContent>
...
LeaderPermissions.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderPermissions;
