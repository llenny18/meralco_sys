// pages/leader/leader-penalties.tsx
...
const COLUMNS = ['project', 'vendor', 'penalty_rule', 'violation_date', 'penalty_amount', 'penalty_status'];

function LeaderPenalties() {
  ...
  return (
    <>
      <Head><title>Penalty Overview - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💰 Penalty Overview</Typography>
            <Typography variant="subtitle2">Review penalty records</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Penalty Overview Management" />
              <Divider />
              <CardContent>
...
LeaderPenalties.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderPenalties;
