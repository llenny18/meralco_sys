// pages/leader/leader-escalation-rules.tsx
...
function LeaderEscalationRules() {
  ...
  return (
    <>
      <Head><title>Escalation Rules - Team Leader</title></Head>
      <PageTitleWrapper>
...
LeaderEscalationRules.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderEscalationRules;
