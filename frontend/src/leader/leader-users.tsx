...
const COLUMNS = ['username', 'email', 'role', 'is_active', 'phone_number', 'last_login'];
...
function LeaderUsers() {
  ...
  return (
    <>
      <Head><title>Users - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>👥 Users</Typography>
            <Typography variant="subtitle2">Manage system users</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
LeaderUsers.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
