// pages/leader/leader-sla-overview.tsx
...
const COLUMNS = ['project', 'sla_rule', 'due_date', 'completion_date', 'status', 'is_breached', 'breach_days'];

function LeaderSlaOverview() {
  ...
  return (
    <>
      <Head><title>SLA Overview - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📈 SLA Overview</Typography>
      ...
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="SLA Overview Management" />
              <Divider />
              <CardContent>
...
LeaderSlaOverview.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderSlaOverview;
