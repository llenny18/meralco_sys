// pages/leader/leader-vendors.tsx
...
const COLUMNS = ['vendor_code', 'vendor_name', 'company_name', 'compliance_score', 'is_active', 'is_blacklisted'];

function LeaderVendors() {
  ...
  return (
    <>
      <Head><title>Vendor Management - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🏢 Vendor Management</Typography>
            <Typography variant="subtitle2">Manage vendor accounts</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Vendor Management Management" />
              <Divider />
              <CardContent>
...
LeaderVendors.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderVendors;
