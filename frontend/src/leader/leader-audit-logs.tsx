// pages/leader/leader-audit-logs.tsx
...
const COLUMNS = ['user', 'action_type', 'entity_type', 'status', 'created_at'];

function LeaderAuditLogs() {
  ...
  return (
    <>
      <Head><title>Audit Logs - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔒 Audit Logs</Typography>
            <Typography variant="subtitle2">View audit trail</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
LeaderAuditLogs.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderAuditLogs;
