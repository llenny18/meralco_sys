// pages/leader/leader-sla-rules.tsx
...
const ENDPOINT = 'sla-rules';
const COLUMNS = ['rule_name', 'stage', 'deadline_days', 'warning_threshold_days', 'is_active'];

function LeaderSlaRules() {
  ...
  return (
    <>
      <Head><title>SLA Rules Management - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚖️ SLA Rules Management</Typography>
            <Typography variant="subtitle2">Configure SLA rules</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="SLA Rules Management Management" />
              <Divider />
              <CardContent>
...
LeaderSlaRules.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderSlaRules;
