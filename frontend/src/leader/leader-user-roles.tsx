// pages/leader/leader-user-roles.tsx
...
const COLUMNS = ['role_name', 'role_description', 'created_at'];

function LeaderUserRoles() {
  ...
  return (
    <>
      <Head><title>User Roles - Team Leader</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🎭 User Roles</Typography>
            <Typography variant="subtitle2">Manage user roles</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="User Roles Management" />
              <Divider />
              <CardContent>
...
LeaderUserRoles.getLayout = (page) => <SidebarLayout userRole="leader">{page}</SidebarLayout>;
export default LeaderUserRoles;
