// pages/supervisor/supervisor-compliance.tsx
...
const COLUMNS = ['project', 'doc_type', 'is_submitted', 'submission_date', 'is_approved', 'due_date', 'is_overdue', 'overdue_days'];
...
function SupervisorCompliance() {
  ...
  return (
    <>
      <Head><title>Document Compliance - WO Supervisor</title></Head>
      <PageTitleWrapper>
...
SupervisorCompliance.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
