// pages/supervisor/supervisor-vendor-performance.tsx
...
function SupervisorVendorPerformance() {
  ...
  return (
    <>
      <Head><title>Vendor Performance - WO Supervisor</title></Head>
      <PageTitleWrapper>
...
SupervisorVendorPerformance.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorVendorPerformance;
