// pages/supervisor/supervisor-project-team.tsx
...
const ENDPOINT = 'project-team';
const COLUMNS = ['project', 'user', 'role_in_project', 'assigned_date', 'is_active'];

function SupervisorProjectTeam() {
  ...
  return (
    <>
      <Head><title>Project Team - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>👥 Project Team</Typography>
            <Typography variant="subtitle2">Manage project team assignments</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Project Team Management" />
              <Divider />
              <CardContent>
...
SupervisorProjectTeam.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorProjectTeam;
