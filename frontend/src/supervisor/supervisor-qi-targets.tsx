// pages/supervisor/supervisor-qi-targets.tsx
...
const COLUMNS = ['qi_user', 'target_date', 'target_audits', 'actual_audits', 'target_met', 'reason_not_met'];

function SupervisorQiTargets() {
  ...
  return (
    <>
      <Head><title>QI Daily Targets - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🎯 QI Daily Targets</Typography>
            <Typography variant="subtitle2">Monitor QI targets</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
SupervisorQiTargets.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorQiTargets;
