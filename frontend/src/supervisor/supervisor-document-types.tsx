// pages/supervisor/supervisor-document-types.tsx
...
const COLUMNS = ['doc_type_name', 'doc_type_description', 'is_required'];

function SupervisorDocumentTypes() {
  ...
  return (
    <>
      <Head><title>Document Types - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📋 Document Types</Typography>
            <Typography variant="subtitle2">Configure document types</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Document Types Management" />
              <Divider />
              <CardContent>
...
SupervisorDocumentTypes.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorDocumentTypes;
