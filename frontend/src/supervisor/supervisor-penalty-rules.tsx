// pages/supervisor/supervisor-penalty-rules.tsx
...
const ENDPOINT = 'penalty-rules';
const COLUMNS = ['rule_name', 'violation_type', 'penalty_formula', 'minimum_penalty', 'maximum_penalty', 'grace_period_days', 'is_active'];

function SupervisorPenaltyRules() {
  ...
  return (
    <>
      <Head><title>Penalty Rules - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⚖️ Penalty Rules</Typography>
            <Typography variant="subtitle2">Configure penalty rules</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Penalty Rules Management" />
              <Divider />
              <CardContent>
...
SupervisorPenaltyRules.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorPenaltyRules;
