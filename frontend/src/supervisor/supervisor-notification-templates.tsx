// pages/supervisor/supervisor-notification-templates.tsx
...
const COLUMNS = ['template_name', 'template_subject', 'notification_type', 'is_active'];

function SupervisorNotificationTemplates() {
  ...
  return (
    <>
      <Head><title>Notification Templates - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📝 Notification Templates</Typography>
            <Typography variant="subtitle2">Manage notification templates</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Notification Templates Management" />
              <Divider />
              <CardContent>
...
SupervisorNotificationTemplates.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorNotificationTemplates;
