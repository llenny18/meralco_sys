// pages/supervisor/supervisor-escalations.tsx
...
const COLUMNS = ['project', 'escalation_rule', 'escalated_from_user', 'escalated_to_user', 'escalation_date', 'status', 'resolution_date'];

function SupervisorEscalations() {
  ...
  return (
    <>
      <Head><title>Escalations - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🚨 Escalations</Typography>
            <Typography variant="subtitle2">Manage escalations</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Escalations Management" />
              <Divider />
              <CardContent>
...
SupervisorEscalations.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorEscalations;
