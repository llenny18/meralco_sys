// pages/supervisor/supervisor-sla-tracking.tsx
...
const ENDPOINT = 'sla-tracking';
const COLUMNS = ['project', 'sla_rule', 'start_date', 'due_date', 'completion_date', 'status', 'is_breached', 'breach_days'];

function SupervisorSlaTracking() {
  ...
  return (
    <>
      <Head><title>SLA Tracking - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📊 SLA Tracking</Typography>
            <Typography variant="subtitle2">Monitor SLA compliance</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="SLA Tracking Management" />
              <Divider />
              <CardContent>
...
SupervisorSlaTracking.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorSlaTracking;
