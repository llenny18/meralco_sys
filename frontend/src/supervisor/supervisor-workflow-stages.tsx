// pages/supervisor/supervisor-workflow-stages.tsx
...
const ENDPOINT = 'workflow-stages';
const COLUMNS = ['stage_name', 'stage_order', 'default_duration_days', 'is_active'];

function SupervisorWorkflowStages() {
  ...
  return (
    <>
      <Head><title>Workflow Stages - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>📝 Workflow Stages</Typography>
            <Typography variant="subtitle2">Configure workflow stages</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Workflow Stages Management" />
              <Divider />
              <CardContent>
...
SupervisorWorkflowStages.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorWorkflowStages;
