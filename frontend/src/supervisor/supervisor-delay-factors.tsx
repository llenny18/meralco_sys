// pages/supervisor/supervisor-delay-factors.tsx
...
const COLUMNS = ['factor_name', 'factor_category', 'factor_description', 'is_active'];

function SupervisorDelayFactors() {
  ...
  return (
    <>
      <Head><title>Delay Factors - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>⏱️ Delay Factors</Typography>
            <Typography variant="subtitle2">Define delay factors</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Delay Factors Management" />
              <Divider />
              <CardContent>
...
SupervisorDelayFactors.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
export default SupervisorDelayFactors;
