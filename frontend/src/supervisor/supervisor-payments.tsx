// pages/supervisor/supervisor-payments.tsx
...
const COLUMNS = ['invoice', 'payment_amount', 'payment_date', 'payment_method', 'payment_reference', 'processed_by'];
...
function SupervisorPayments() {
  ...
  return (
    <>
      <Head><title>Payments - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>💳 Payments</Typography>
            <Typography variant="subtitle2">Track payments</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
...
SupervisorPayments.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
