// pages/supervisor/supervisor-workflow.tsx
...
const COLUMNS = ['project', 'stage', 'assigned_user', 'start_date', 'due_date', 'completion_date', 'status', 'is_current_stage'];

function SupervisorWorkflow() {
  ...
  return (
    <>
      <Head><title>Workflow Management - WO Supervisor</title></Head>
      <PageTitleWrapper>
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Typography variant="h3" component="h3" gutterBottom>🔄 Workflow Management</Typography>
            <Typography variant="subtitle2">Manage project workflows</Typography>
          </Grid>
        </Grid>
      </PageTitleWrapper>
      <Container maxWidth="lg">
        <Grid container direction="row" justifyContent="center" alignItems="stretch" spacing={3}>
          <Grid item xs={12}>
            <Card>
              <CardHeader action={<Button variant="contained" startIcon={<AddTwoToneIcon />} onClick={handleAdd}>Add New</Button>} title="Workflow Management Management" />
              <Divider />
              <CardContent>
...
SupervisorWorkflow.getLayout = (page) => <SidebarLayout userRole="supervisor">{page}</SidebarLayout>;
