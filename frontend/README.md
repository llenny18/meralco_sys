<p align="center">
    <a href="https://bloomui.com" title="BloomUI.com">
        <img src="https://bloomui.s3.us-east-2.amazonaws.com/tokyo-logo.png" alt="Aims WO">
    </a>
</p>
<h1 align="center">
    <b>Aims WO</b>
...
<p>
    Aims WONext.js Typescript Dashboard is built using the latest industry standards and features a clean and premium design style, making use of colors and accents to improve the user experience for all included flows and pages.
</p>
<p>
...
<ol>
    ...
    <li>Clone repository: <code>git clone https://github.com/bloomui/Aims WO.git</code></li>
